...
fn result_card(result: hexdocs.TypeSense) {
  echo result
  html.div(
    [attribute.class("w-full bg-slate-100 dark:bg-slate-800 rounded-2xl p-4")],
    [
      html.div([attribute.class("text-slate-700 dark:text-slate-300 text-sm")], [
      ...
      html.div(
        ...
        [
          html.span(
            [attribute.class("text-blue-600 dark:text-blue-400 text-sm")],
      ...
      case result.highlight {
        hexdocs.Highlights(doc: option.Some(doc), ..) -> {
          html.p(
            ...
            // html.span(
            //   [attribute.class("bg-slate-950 text-slate-100 px-1 rounded")],
            //   [html.text("for")],
            // ),
            // html.text(
